...
// ============================================================
// WeLoveChile Route Dispatcher v7.2.0 (Saída por tour + clustering 2D)
//
// MUDANÇA vs v7.0:
  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <div style={styles.subBrand}>Route Dispatcher · Santiago · v7.2.0 · Saída por tour</div>
          </div>
        </div>
              ...
              {!resultado && !processando && (
                <div style={styles.empty}>
                  ...
                  <div style={styles.emptyHint}>
                    v7.2.0: rota flui rumo ao ponto de saída do tour,<br />
      ...
      <footer style={styles.footer}>
        <span>WeLoveChile · v7.2.0 · Saída por tour</span>
