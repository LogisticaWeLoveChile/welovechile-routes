...
// ============================================================
// WeLoveChile Route Dispatcher v7.4.0 (Vans grandes = grupos grandes + mescla geocode)
//
// MUDANÇA vs v7.0:
  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <div style={styles.subBrand}>Route Dispatcher · Santiago · v7.4.0 · Vans grandes</div>
          </div>
        </div>
      ...
      <footer style={styles.footer}>
        <span>WeLoveChile · v7.4.0 · Vans grandes</span>
