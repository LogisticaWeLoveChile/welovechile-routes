...
// ============================================================
// WeLoveChile Route Dispatcher v7.2.1 (Saída por tour + encaixe com folga mínima + sobras)
//
// MUDANÇA vs v7.0:
...
async function otimizarVan(pontosVan, saidaTour, invertido, horarioPartida) {
  ...
  var porDist = ok.slice().sort(function (a, b) { return distSaidaKm(b, saidaTour) - distSaidaKm(a, saidaTour); });
...
function clusterizarPorVans(pontosOrd, vansDisponiveis) {
  ...
  var forcado = particionarEncaixeForcado(pontosOrd, sorted.slice(0, Kmax));
...
// ============================================================
function particionarEncaixeForcado(pontosOrd, vansSel) {
...
// ============================================================
async function processarRotaV7(reservas, saidaTour, invertido, horarioInicio, cache, vansDisponiveis, onProgress) {
  ...
  // Ordena pela projeção no eixo centróide→saída: mais distante da saída primeiro.
  ...
  if (!clusterResult || clusterResult.tipo === "erro_encaixe") {
    ...
    var parcial = particionarEncaixeForcado(ordenados, vansDisponiveis);
    if (typeof console !== "undefined") {
  ...
  return { fatiasComRota: fatiasComRota, tipoParticao: clusterResult.tipo, dif: clusterResult.dif, sobras: sobras };
}
...
export default function App() {
  ...
  async function gerarRota() {
    ...
    try {
      ...
      var resultado7 = await processarRotaV7(unificadas, saidaEfetiva, invertidoEfetivo, horarioEf, cache, vansExp, setStatusMsg);
  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <div style={styles.subBrand}>Route Dispatcher · Santiago · v7.2.1 · Saída por tour</div>
          </div>
        </div>
              ...
              {!resultado && !processando && (
                <div style={styles.empty}>
                  ...
                  <div style={styles.emptyHint}>
                    v7.2.1: rota flui rumo ao ponto de saída do tour,<br />
      ...
      <footer style={styles.footer}>
        <span>WeLoveChile · v7.2.1 · Saída por tour</span>
