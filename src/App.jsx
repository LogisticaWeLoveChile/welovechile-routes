...
// ============================================================
// WeLoveChile Route Dispatcher v7.3.0 (Setorização + limite de paradas + 2-opt)
//
// MUDANÇA vs v7.0:
...
function clusterizarPorVans(pontosOrd, vansDisponiveis, maxParadas) {
  ...
  if (maxParadas !== Infinity) {
    ...
    if (comLimite && comLimite.tipo !== "erro_encaixe") return comLimite;
  ...
  return (
    <div style={styles.app}>
      ...
      <header style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <div style={styles.subBrand}>Route Dispatcher · Santiago · v7.3.0 · Setorização</div>
          </div>
        </div>
      ...
      <footer style={styles.footer}>
        <span>WeLoveChile · v7.3.0 · Setorização</span>
